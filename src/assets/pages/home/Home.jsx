import MultiSlider from "../../components/carousel/MultiSlider";
...
// import chef from '../../../images/home/chef-service.jpg';
...
const Home = () => {
    return (
        <div>
            <FavAndTitle title='Lime Lite | Home'></FavAndTitle>
            <div>
                <Slider></Slider>
            </div>
                            ...
                            <div className="mt-12 space-y-12">
                                <div className="flex">
                                    <div className="flex-shrink-0">
                                        <div className="flex items-center justify-center w-12 h-12 rounded-md dark:bg-lime-400 dark:text-gray-900">
