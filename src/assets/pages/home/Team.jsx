    ...
    return (
        <section className="py-6 dark:bg-gray-700 dark:text-gray-100">
            <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
                ...
                <h1 className="text-4xl font-bold leadi text-center sm:text-5xl">The talented Trainer for You Here</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-between mt-8">
                    <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-gray-100 dark:text-gray-800">
                        ...
                        <div className="flex-1 my-4">
                            ...
                            <div>
                                <p>Will be Skills Tag Here</p>
                                <p>Year Of Experience: 10</p>
                                <h4>Available Time Slot: 6</h4>
                            </div>
                        </div>
