            ...
            <section className="">
                <div className="container px-4 mx-auto">
                    <div className="max-w-2xl mx-auto mb-16 text-center">
                        <span className="font-bold tracki uppercase dark:text-lime-400">Pricing</span>
                            ...
                            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                                ...
                                <ul className="flex-1 mb-6 dark:text-gray-400">
                                    <li className="flex mb-2 space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 dark:text-lime-400">
                                ...
                                <Link to='/payment'><button className="inline-block px-5 py-3 font-semibold w-full tracki text-center rounded dark:bg-lime-400 dark:text-gray-900">Join Now</button></Link>
                            </div>
                        </div>
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-lime-400 dark:text-gray-900">
                                <div className="space-y-2">
                                    <h4 className="text-2xl font-bold">Gold</h4>
                                    <span className="text-6xl font-bold">$40
                                        <span className="text-sm tracki">/month</span>
                                    </span>
                                </div>
                                ...
                                <Link to='/payment'><button className="inline-block px-5 py-3 font-semibold w-full tracki text-center rounded bg-black text-lime-400">Join Now</button></Link>
                            </div>
                        </div>
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
